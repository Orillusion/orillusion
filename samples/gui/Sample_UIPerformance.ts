import { BoundingBox, Color, Engine3D, GUIConfig, Object3D, Scene3D, TextAnchor, UITextField, Vector2, Vector3, ViewPanel, clamp } from "@orillusion/core";
...
class SpriteSheet {
    ...
    private frameSpeed: number = 0.2 + Math.random() * 0.8;
...
export class Sample_UISpriteSheet {
    ...
    private createSpriteSheets(root: Object3D) {
        ...
        color.r = clamp(color.r, 0.5, 1);
        color.g = clamp(color.g, 0.5, 1);
        color.b = clamp(color.b, 0.5, 1);
