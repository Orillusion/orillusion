export class computenormal {
    public static cs: string = /* wgsl */ `
        ...
        fn CsMain(
            ...
            atomicAdd(&atomicnormal[index0 * u32(4) + u32(0)], i32(temp.x * 100000000.0));
            atomicAdd(&atomicnormal[index0 * u32(4) + u32(1)], i32(temp.y * 100000000.0));
            atomicAdd(&atomicnormal[index0 * u32(4) + u32(2)], i32(temp.z * 100000000.0));
            atomicAdd(&atomicnormal[index0 * u32(4) + u32(3)], i32(1.0));
            atomicAdd(&atomicnormal[index1 * u32(4) + u32(0)], i32(temp.x * 100000000.0));
            atomicAdd(&atomicnormal[index1 * u32(4) + u32(1)], i32(temp.y * 100000000.0));
            atomicAdd(&atomicnormal[index1 * u32(4) + u32(2)], i32(temp.z * 100000000.0));
            atomicAdd(&atomicnormal[index1 * u32(4) + u32(3)], i32(1.0));
            atomicAdd(&atomicnormal[index2 * u32(4) + u32(0)], i32(temp.x * 100000000.0));
            atomicAdd(&atomicnormal[index2 * u32(4) + u32(1)], i32(temp.y * 100000000.0));
            atomicAdd(&atomicnormal[index2 * u32(4) + u32(2)], i32(temp.z * 100000000.0));
