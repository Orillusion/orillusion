import { Object3D, Scene3D, PositionAudio, Engine3D, AtmosphericComponent, Vector3, Camera3D, OrbitController, View3D, PointerEvent3D, Interpolator, InterpolatorEnum, MeshRenderer, BoxGeometry, LitMaterial, Color, ColliderComponent, DirectLight, KelvinUtil } from "@orillusion/core";

export class SampleSkeleton {
    lightObj: Object3D;
    scene: Scene3D;
    camera: Object3D
    mats: any[];
