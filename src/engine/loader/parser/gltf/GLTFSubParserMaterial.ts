...
export class GLTFSubParserMaterial {
    ...
    public async parse(materialId: number) {
        let material;
        ...
        if (pbrMetallicRoughness) {
            ...
            if (baseColorTexture) {
                ...
                if (texture) {
                    ...
                    dmaterial.baseColorTexture = defaultRes.redTexture;
                }
            }
            ...
            if (metallicRoughnessTexture) {
                ...
                if (texture) {
                    ...
                    dmaterial.metallicRoughnessTexture = defaultRes.blackTexture;
                }
            }
        } else {
            Object.assign(dmaterial, {
        ...
        if (normalTexture) {
            ...
            if (texture) {
                ...
                dmaterial.normalTexture = defaultRes.normalTexture;
            }
        }
        ...
        if (emissiveTexture) {
            ...
            if (texture) {
                ...
                dmaterial.emissiveTexture = defaultRes.blackTexture;
            }
        }
