...
export class CastShadow {
  public static shadowCastMap_vert_wgsl: string = /* wgsl */ `
      ...
      `;
  public static castPointShadowMap_vert_wgsl: string = /* wgsl */ `
      #include "WorldMatrixUniform"
      #include "GlobalUniform"
      ...
      `;
  public static shadowCastMap_frag_wgsl: string = /* wgsl */ `
      #if USE_ALPHACUT
        @group(1) @binding(0)
