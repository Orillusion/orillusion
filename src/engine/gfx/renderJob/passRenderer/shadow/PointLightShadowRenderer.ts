...
export class PointLightShadowRenderer extends RendererBase {
    ...
    private _shadowCameraDic: Map<LightBase, CubeShadowMapInfo>;
    ...
    constructor() {
        ...
        this._shadowCameraDic = new Map<LightBase, CubeShadowMapInfo>();
    ...
    public getShadowCamera(view: View3D, lightBase: LightBase): CubeShadowMapInfo {
