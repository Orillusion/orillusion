...
export class ShadowMapPassRenderer extends RendererBase {
    ...
    protected recordShadowRenderBundleNode(view: View3D, shadowCamera: Camera3D, encoder, nodes: RenderNode[]) {
        GPUContext.bindCamera(encoder, shadowCamera);
    ...
    protected drawShadowRenderNodes(view: View3D, shadowCamera: Camera3D, encoder: GPURenderPassEncoder, nodes: RenderNode[]) {
        GPUContext.bindCamera(encoder, shadowCamera);
