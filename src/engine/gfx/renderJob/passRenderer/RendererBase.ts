...
export class RendererBase extends CEventDispatcher {
    ...
    protected renderBundleOp(view: View3D, collectInfo: CollectInfo, occlusionSystem: OcclusionSystem) {
        ...
        if (entityBatchCollect) {
            ...
            entityBatchCollect.renderGroup.forEach((v) => {
                if (v.bundleMap.has(this._rendererType)) {
                    ...
                    this.recordRenderBundleNode(view, renderBundleEncoder, v.renderNodes);
    ...
    protected renderBundleTr(view: View3D, collectInfo: CollectInfo, occlusionSystem: OcclusionSystem) {
    ...
    protected recordRenderBundleNode(view: View3D, encoder, nodes: RenderNode[]) {
    ...
    protected drawRenderNodes(view: View3D, encoder: GPURenderPassEncoder, command: GPUCommandEncoder, nodes: RenderNode[], occlusionSystem: OcclusionSystem) {
        GPUContext.bindCamera(encoder, view.camera);
