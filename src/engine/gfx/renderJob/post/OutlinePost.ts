...
export class OutlinePostData {
    public readonly SlotCount: number = 8; //Supports up to 8 different color selections
    public readonly MaxEntities: number = 16; //Maximum quantity within the same group
...
/**
 * Outline Post
 * Fill in object data for stroke through OutlinePostManager
 * ```
...
export class OutlinePost extends PostBase {
    ...
    private createResource() {
        ...
        this.slotsArray = new Float32Array(outlinePostData.SlotCount * 4); //Reserve 4 write other parameters
