...
export class SolidColorSky extends HDRTextureCube {
    ...
    constructor(color: Color) {
        ...
        let numbers = [];
        defaultRes.fillColor(numbers, this._minSize, this._minSize, this.color.r, this.color.g, this.color.b, this.color.a);
    ...
    private changeColor(color: Color): this {
        this._skyColor = color;
        defaultRes.fillColor(this._internalTexture.floatArray, this._minSize, this._minSize, this.color.r, this.color.g, this.color.b, this.color.a);
