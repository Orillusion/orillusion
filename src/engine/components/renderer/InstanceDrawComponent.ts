...
export class InstanceDrawComponent extends RenderNode {
    ...
    public nodeUpdate(view: View3D, passType: RendererType, renderPassState: RendererPassState, clusterLightingRender?: ClusterLightingRender): void {
        ...
        this._keyGroup.forEach((v, k) => {
            ...
            renderNode.nodeUpdate(view, passType, renderPassState, clusterLightingRender);
        })
